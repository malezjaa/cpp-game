...
void NineSlice::Draw(const Texture2D &texture, const Rectangle source, const Rectangle destination,
  ...
  DrawRegion(texture, {source.x, source.y, borders.left, borders.top}, {destination.x, destination.y, left, top}, tint);
  ...
  DrawRegion(texture,
             {source.x + source.width - borders.right, source.y + borders.top, borders.right, source_center_height},
  ...
  DrawRegion(texture,
             ...
             {destination.x + left, destination.y + destination.height - bottom, destination_center_width, bottom},
             tint);
  DrawRegion(texture,
